      ...
      <div className="flex h-full w-full">
        ...
        <div className="w-full xl:w-1/2 flex flex-col items-center justify-center px-4 py-6 sm:px-6 sm:py-8 md:px-8 md:py-10 lg:px-12 lg:py-12 xl:px-24 relative min-h-screen">
            ...
            <ul className="space-y-2 sm:space-y-3 md:space-y-4 lg:space-y-6 text-gray-500 text-center">
              ...
              <li>
                ...
                <Link
                  ...
                  className="hover:text-black transition-colors text-xs sm:text-sm md:text-base lg:text-lg font-medium tracking-wide"
          ...
          <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-2xl xl:max-w-none mt-[10px] lg:mt-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-[130px] text-xs sm:text-sm text-gray-500 mb-4 sm:mb-6 md:mb-8">
              ...
              <div className="space-y-4 sm:space-y-6 md:space-y-8">
                ...
                <div className="text-left">
                  ...
                  <h3 className="font-semibold mb-1 sm:mb-2 text-gray-700 text-xs sm:text-sm">
              ...
              <div className="space-y-4 sm:space-y-6 md:space-y-8">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs sm:text-sm uppercase max-w-md">

                    Agasti Ventures LLP. Plot no. 34, Sy no. 66 & 67, 5th floor,

                    Alekhya Pranava, Jubilee Enclave, Hitech City, Hyderabad.
