  ...
  const features = [
    {
      ...
      ios_icon: "/Icons/building_small.mov",
      fallback: "/innovation.png",
      label: "INNOVATION",
    },
    {
      icon: "/icons%20webm%203/sustainable.webm",
      ios_icon: "/Icons/eco_building_small.mov",
    ...
    },
    {
      ...
      ios_icon: "/Icons/block_small.mov",
    ...
    },
    {
      ...
      ios_icon: "/Icons/big_b_small.mov",
    ...
    },
    {
      ...
      ios_icon: "/Icons/serenity_small.mov",
      ...
      <ContainerLayout paddingX="px-6 sm:px-[48px]">
        ...
        <div className="mb-8 sm:mb-12">
          ...
          <p className="text-gray-500 text-[16px] sm:text-sm leading-tight max-w-3xl">
            ...
            you the ideal blend of exclusivity and convenience.
          </p>
        </div>
                ...
                <div className="relative w-20 h-20 mb-4 flex items-center justify-center">
                  {feature.icon.endsWith(".webm") ? (
                    <video
                      ...
                      onLoadStart={() =>
                        console.log(`Loading mobile video: ${feature.icon}`)
                      }
                      onLoadedData={() =>
                        console.log(
                          `Mobile video loaded successfully: ${feature.icon}`,
                        )
                      }
                      onError={(e) => {
                        console.error(
                          `Failed to load mobile video: ${feature.icon}`,
                          e,
                        );
                    ...
                    >
                      <source src={feature.ios_icon} type="video/quicktime" />
                ...
                <div className="relative w-20 h-20 mb-4 flex items-center justify-center">
                  {features[4].icon.endsWith(".webm") ? (
                    <video
                      ...
                      onLoadStart={() =>
                        console.log(`Loading mobile video: ${features[4].icon}`)
                      }
                      onLoadedData={() =>
                        console.log(
                          `Mobile video loaded successfully: ${features[4].icon}`,
                        )
                      }
                      onError={(e) => {
                        console.error(
                          `Failed to load mobile video: ${features[4].icon}`,
                          e,
                        );
                        // Fallback to PNG if WebM fails
                        const target = e.target as HTMLVideoElement;
                ...
                <div className="relative w-16 h-16 lg:w-28 lg:h-28 mb-4 flex items-center justify-center">
                  {feature.icon.endsWith(".webm") ? (
                    <video
                      ...
                      poster={feature.fallback}
                      onLoadStart={() =>
                        console.log(`Loading desktop video: ${feature.icon}`)
                      }
                      onLoadedData={() =>
                        console.log(
                          `Desktop video loaded successfully: ${feature.icon}`,
                        )
                      }
                      onError={(e) => {
                        console.error(
                          `Failed to load desktop video: ${feature.icon}`,
                          e,
                        );
                        // Fallback to PNG if WebM fails
                        const target = e.target as HTMLVideoElement;
